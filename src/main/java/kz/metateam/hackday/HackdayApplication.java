...
//
//            University aitu = universityService.save(new University("Астана IT университет", "Нур-Султан", "Акмолинская область"));
//            universityService.addSpecializationToUniversity(technology, aitu);
//            universityService.addSpecializationToUniversity(security, aitu);
//
//            University kbtu = universityService.save(new University("Казахстанско-Британский технический университет", "Алмата", "Алматинская область"));
//            universityService.addSpecializationToUniversity(technology, kbtu);
//            universityService.addSpecializationToUniversity(security, kbtu);
//
//            University alfarabi = universityService.save(new University("Казахский национальный университет имени Аль-Фараби", "Алмата", "Алматинская область"));
//            universityService.addSpecializationToUniversity(chemPhysics, alfarabi);
//
//            University narhoz = universityService.save(new University("Университет Нархоз", "Алмата", "Алматинская область"));
//            universityService.addSpecializationToUniversity(sreda, narhoz);
//
//
